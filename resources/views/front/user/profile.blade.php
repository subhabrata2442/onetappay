...
<!-- <section class="home-banner position-relative">
        <span class="plate-img"> <img class="img-block" src="{{ asset('public/front/images/plate.png') }}" alt=""> </span> </section> -->
                    ...
                    <div id="content" class="tab-content" role="tablist">
                        ...
                        <div id="pane-B" class="card tab-pane fade {{ $tab == 2 ? 'show active' : '' }}" role="tabpanel" aria-labelledby="tab-B">
                            <div class="card-header" role="tab" id="heading-B">
                                <h5 class="mb-0"> <a class="collapsed" data-bs-toggle="collapse" href="#collapse-B" aria-expanded="false" aria-controls="collapse-B"> address
                                        book </a> </h5>
                            </div>
                            <div id="collapse-B" class="collapse when-mobile" data-bs-parent="#content" role="tabpanel" aria-labelledby="heading-B">
                                <div class="card-body">
                                    ...
                                    <div class="row address_book_sec">
                                        <div class="col-12">
                                            <div class="pro-btn-wrap">
                                                <div class="pro-btn-wrap"> <a href="javascript:;" class="pro-btn-new add_new_address_btn">add new address</a>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div id="pane-C" class="card tab-pane fade {{ $tab == 3 ? 'show active' : '' }}" role="tabpanel" aria-labelledby="tab-C">
                            <div class="card-header" role="tab" id="heading-C">
                                <h5 class="mb-0"> <a class="collapsed" data-bs-toggle="collapse" href="#collapse-C" aria-expanded="true" aria-controls="collapse-C"> order history </a> </h5>
                            </div>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <button class="toggle-btn collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapse{{ $order_row->order_id }}" aria-expanded="false" aria-controls="flush-collapse{{ $order_row->order_id }}">
                                                                <i class="fa-solid fa-chevron-down"></i>
                                                                #{{ $order_row->order_id_token }}</button>
                                                            @else
                                                            #{{ $order_row->order_id_token }}
                                                            @endif
                                                        </td>
                                                        <td>{{ $order_row->created_at }}</td>
                                                        <td>{{ $order_row->merchant_info->restaurant_name }}
                                                        </td>
                                                        ...
                                                        <td>
                                                            ...
                                                            <span class="label order-status bg-yellow">Pending</span>
                                                            @elseif($order_row->status == 'cancel')
                                                            <span class="label order-status bg-red">Canceled</span>@else<span class="label order-status bg-success">Accepted</span>
                                                            @endif
                                                            @else
                                                            <span class="label order-status bg-red">Payment
                                                                failed</span>
                                                            @endif
                                                        </td>
                                                    </tr>
                                                            ...
                                                            <div id="flush-collapse{{ $order_row->order_id }}" class="accordion-collapse collapse" aria-labelledby="flush-heading{{ $order_row->order_id }}" data-bs-parent="#accordionFlushExample">
                                                                <table class="table">
                                                                    ...
                                                                    <tfoot class="text-nowrap">
                                                                        <tr>
                                                                            <td class="text-end" colspan="4"><strong>Total
                                                                                    :</strong></td>
                                                                            <td class="text-end"><strong><span class="d-block">$
                                                                                        {{ $order_row->gross_total }}</span></strong>
                                                                            </td>
                                                                        </tr>
                                                                    </tfoot>
                                                                </table>
                        ...
                        <div id="pane-D" class="card tab-pane fade {{ $tab == 4 ? 'show active' : '' }}" role="tabpanel" aria-labelledby="tab-D">
                            <div class="card-header" role="tab" id="heading-D">
                                <h5 class="mb-0"> <a class="collapsed" data-bs-toggle="collapse" href="#collapse-D" aria-expanded="true" aria-controls="collapse-D"> Booking History </a> </h5>
                            </div>
                            <div id="collapse-D" class="collapse when-mobile" data-bs-parent="#content" role="tabpanel" aria-labelledby="heading-D">
                                <div class="card-body">
                                    @if (count($table_booking_history) > 0)
                                    <div class="order-history-table">
                                        <div class="table-responsive accordion accordion-flush" id="tablebookingaccordionFlushExample">
                                            <table class="table text-nowrap">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td>{{ $count }}</td>
                                                        <td><button class="toggle-btn collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapse-t{{ $table_booking_row->id }}" aria-expanded="false" aria-controls="flush-collapse-t{{ $table_booking_row->id }}">
                                                                <i class="fa-solid fa-chevron-down"></i>
                                                                #{{ $table_booking_row->booking_id }}</button>
                                                        </td>
                                                        <td>{{ $table_booking_row->date_slot }}</td>
                                                        <td>{{ $table_booking_row->time_slot }}</td>
                                                        <td>{{ $table_booking_row->merchant->restaurant_name }}
                                                        </td>
                                                        <td>{{ $table_booking_row->total_person }}</td>
                                                        <td>
                                                            @if ($table_booking_row->status == 1)
                                                            <span class="label order-status bg-yellow">Pending</span>
                                                            @elseif($table_booking_row->status == 0)
                                                            <span class="label order-status bg-red">Canceled</span>@else<span class="label order-status bg-success">Booked</span>
                                                            @endif
                                                        </td>
                                                        <td>
                                                            @if ($table_booking_row->status == 1)
                                                            <a href="javascript:;" class="btn btn-danger btn-sm request_cancel_booking" data-toggle="tooltip" title="Cancel booking" data-booking_id="{{ $table_booking_row->id }}">Cancel
                                                                booking</a>
                                                            @endif
                                                        </td>
                                                    </tr>
                                                            ...
                                                            <div id="flush-collapse-t{{ $table_booking_row->id }}" class="accordion-collapse collapse" aria-labelledby="flush-collapse-t{{ $table_booking_row->id }}" data-bs-parent="#tablebookingaccordionFlushExample">
                                                                <div class="row justify-content-center">
                                                                    <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                                                                        <div class="user-book-history">
                                                                            ...
                                                                            <div class="booked-history-detls">
                                                                                <div class="booked-history-detls-lft">
                                                                                    <div class="booked-history-detls-head">
                                                                                        Total Guest</div>
                                                                                </div>
                                                                                <div class="booked-history-detls-rgt">
                                                                                    <div class="booked-history-detls-dtls">
                                                                                        : <span class="total-booked-person">{{ $table_booking_row->total_person }}
                                                                                            person</span></div>
                                                                                </div>
                                                                            </div>
                                                                            <div class="booked-history-detls">
                                                                                ...
                                                                                <div class="booked-history-detls-rgt">
                                                                                    <div class="booked-history-detls-dtls">
                                                                                        : <span class="total-booked-person">{{ $table_booking_row->date_slot }}</span>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            <div class="booked-history-detls">
                                                                                ...
                                                                                <div class="booked-history-detls-rgt">
                                                                                    <div class="booked-history-detls-dtls">
                                                                                        : <span class="total-booked-person">{{ $table_booking_row->time_slot }}</span>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            <div class="booked-history-detls">
                                                                                ...
                                                                                <div class="booked-history-detls-rgt">
                                                                                    <div class="booked-history-detls-dtls">
                                                                                        : <span class="total-booked-person">{{ $table_booking_row->table->table_name }}
                                                                                        </span></div>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="user-book-history">
                                                                            <h4>User Details</h4>
                                                                            <div class="history-user-details-wrap">
                                                                                {{ $table_booking_row->customer_name }}
                                                                            </div>
                                                                            <div class="history-user-details-wrap">
                                                                                {{ $table_booking_row->email }}
                                                                            </div>
                                                                            <div class="history-user-details-wrap">
                                                                                {{ $table_booking_row->phone }}
                                                                            </div>
                                                                        </div>
                                                                        <div class="user-book-history">
                                                                            <h4>Special Request</h4>
                                                                            <div class="history-user-details-wrap">
                                                                                {{ $table_booking_row->special_note }}
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                        ...
                        <div id="pane-E" class="card tab-pane fade {{ $tab == 5 ? 'show active' : '' }}" role="tabpanel" aria-labelledby="tab-E">
                            <div class="card-header" role="tab" id="heading-E">
                                <h5 class="mb-0"> <a class="collapsed" data-bs-toggle="collapse" href="#collapse-E" aria-expanded="true" aria-controls="collapse-E"> credit cards </a> </h5>
                            </div>
