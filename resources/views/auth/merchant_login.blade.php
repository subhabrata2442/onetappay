...
<div class="limiter">
  <div class="container-login100" style="background-image: url({{ asset('public/backoffice/images/bg-01.jpg') }});">
    <div class="wrap-login100"> {!! Form::open(['url'=>'merchant_admin', 'class'=>'login100-form validate-form', 'id' => 'admin-login-form', 'autocomplete' => 'off']) !!}
      <div class="logArea">
        <!--<div class="logAreaLeft">
            <img src="{{ asset('public/images/logo.png') }}" alt="">
        </div>-->
        <div class="logAreaRight">
            <h3 class="logoText"><b style="font-size:24px">Merchant Login</b> </h3>
