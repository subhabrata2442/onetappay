...
@endphp
  ...
  <div class="container-fluid left-right-gap">
      ...
      <div class="col-auto">
          ...
          <div>Time: 11:00 AM to 11:00 PM <span class="hotel-open position-relative"> <span class="open-time">(Open Now)<i class="fa-solid fa-angle-down"></i></span>
  ...
  <div class="container-fluid left-right-gap"> @if(count($store_table)>0)
        <div class="booked_table" {{$is_booked_table}}>
        @if(Auth::user() && $user_type==3)
      <form class="forms has-validation-callback" action="{{route('store.booking_table.save')}}" method="POST" id="table_booking-form" onsubmit="return false;">
            @csrf
          ...
          <div class="table-book-wrap-lft">
              ...
              <ul class="d-flex step-process-head-list">
                  ...
                  <div class="process-head-text">
                        <div class="d-flex flex-column align-items-center justify-content-center h-100"> <i class="fa-solid fa-user"></i> <strong>head</strong> </div>
                      </div>
                </li>
                    <li class="col step_bar" id="step2_progress_bar">
                  <div class="process-head-text">
                        <div class="d-flex flex-column align-items-center justify-content-center h-100"> <i class="fa-solid fa-calendar-days"></i> <strong>date</strong> </div>
                      </div>
                </li>
                    <li class="col step_bar" id="step3_progress_bar">
                  <div class="process-head-text">
                        <div class="d-flex flex-column align-items-center justify-content-center h-100"> <i class="fa-solid fa-clock"></i> <strong>time</strong> </div>
                      </div>
                </li>
                    <li class="col step_bar" id="step4_progress_bar">
                  <div class="process-head-text">
                        <div class="d-flex flex-column align-items-center justify-content-center h-100"> <i class="fa-solid fa-table"></i> <strong>Table</strong> </div>
                      </div>
                </li>
                    <li class="col step_bar" id="step5_progress_bar">
                  <div class="process-head-text">
                        <div class="d-flex flex-column align-items-center justify-content-center h-100"> <i class="fa-solid fa-user"></i> <strong>User</strong> </div>
                      </div>
                </li>
                  </ul>
              <div class="booked-step-process-box tab-pane" id="step1">
                  ...
                  <div class="head-booked-wrap">
                        <p>I want to book for <span class="person-book-select">
                          <select class="form-control selectOption_1 person-select" id="total_person" name="total_person">
                  ...
                  <div class="nxt-prv-btn-wrap">
                      ...
                      <li><a href="javascript:;" class="nxt-prv-btn next-step" data-step="1" data-nextstep="2">next</a></li>
                      <!-- <li><button type="button" class="nxt-prv-btn">book</button></li> -->
                    </ul>
                      </div>
                </div>
                  </div>
              <div class="booked-step-process-box tab-pane" id="step2" style="display:none">
                    <div class="step-box-date">
                  <div class="d-flex date-pick-caln"> {!! $calendar !!}
                        {!! $next_calendar !!}
                        <input type="hidden" name="booking_date" id="booking_date">
                      </div>
                  <div class="nxt-prv-btn-wrap">
                        <ul class="d-flex justify-content-between">
                      <li><a href="javascript:;" class="nxt-prv-btn prev-step" data-step="2" data-prevstep="1">Previous</a></li>
                      <li><a href="javascript:;" class="nxt-prv-btn next-step" data-step="2" data-nextstep="3">next</a></li>
                      <!-- <li><button type="button" class="nxt-prv-btn">book</button></li> -->
                    </ul>
                      </div>
                </div>
                  </div>
              <div class="booked-step-process-box tab-pane" id="step3" style="display:none">
                    <div class="step-box-date">
                  <div class="date-pick-caln time-pick-wrap">
                        ...
                        <input type="hidden" name="booking_time_slot" id="booking_time_slot">
                        <ul class="d-flex flex-wrap" id="timeslot_section">
                    </ul>
                      </div>
                  <div class="nxt-prv-btn-wrap">
                        <ul class="d-flex justify-content-between">
                      <li><a href="javascript:;" class="nxt-prv-btn prev-step" data-step="3" data-prevstep="2">Previous</a></li>
                      <li><a href="javascript:;" class="nxt-prv-btn next-step" data-step="3" data-nextstep="4">next</a></li>
                      <!-- <li><button type="button" class="nxt-prv-btn">book</button></li> -->
                    </ul>
                      </div>
                </div>
                  </div>
              <div class="booked-step-process-box tab-pane" id="step4" style="display:none">
                    <div class="step-box-person">
                  <div class="date-pick-caln time-pick-wrap">
                        <div class="time-pick-head">choose your Table</div>
                        <input type="hidden" name="booking_table_id" id="booking_table_id">
                        <input type="hidden" name="booking_table_name" id="booking_table_name">
                        <div id="book_table_section"> </div>
                      </div>
                  <div class="nxt-prv-btn-wrap">
                        <ul class="d-flex justify-content-between">
                      <li><a href="javascript:;" class="nxt-prv-btn prev-step" data-step="4" data-prevstep="3">Previous</a></li>
                      <li><a href="javascript:;" class="nxt-prv-btn next-step" data-step="4" data-nextstep="5">next</a></li>
                    </ul>
                      </div>
                </div>
                  </div>
              <div class="booked-step-process-box tab-pane" id="step5" style="display:none">
                    <div class="step-box-person">
                  <div class="date-pick-caln time-pick-wrap">
                      ...
                      <div class="row g-3">
                          ...
                          <input type="text" name="customer_name" id="customer_name" class="form-control gaust-input-style" placeholder="Customer Name">
                        </div>
                            <div class="gaust-input-wrap">
                          <input name="customer_phone" id="customer_phone" type="tel" class="form-control gaust-input-style" placeholder="Enter Phone">
                        </div>
                            <div class="gaust-input-wrap">
                          <input type="E-Mail" name="customer_email" id="customer_email" class="form-control gaust-input-style" placeholder="E-mail">
                        </div>
                            <div class="gaust-txtare-wrap">
                          <textarea rows="4" name="customer_special_request" id="customer_special_request" class="form-control gaust-txtare-style" placeholder="Special Request (Optional)"></textarea>
                        </div>
                            <div class="capchaArea">
                          <div class="help-captcha w-100">
                                <div class="g-recaptcha" data-sitekey="6LfgCMkjAAAAADdDPhZ5iH196OjreIraMlGtlCX4" data-callback="recaptchaCallback" data-expired-callback="recaptchaExpired"></div>
                  ...
                  <div class="nxt-prv-btn-wrap">
                        <ul class="d-flex justify-content-between">
                      <li><a href="javascript:;" class="nxt-prv-btn prev-step" data-step="5" data-prevstep="4">Previous</a></li>
                      <li><a href="javascript:;" class="nxt-prv-btn next-step" data-step="5">Submit</a></li>
                    </ul>
                      </div>
                </div>
                  </div>
          ...
          <div class="table-book-wrap-rgt">
              ...
              <div class="booked-detls">
                  ...
                  <div class="booked-detls-dtls">: <span class="total-booked-person" id="total-booked-person-view"></span></div>
                </div>
                  </div>
              <div class="booked-detls">
                    <div class="booked-detls-lft">
                  <div class="booked-detls-head">date</div>
                    ...
                    <div class="booked-detls-rgt">
                  <div class="booked-detls-dtls">: <span class="total-booked-person" id="booked-date-view"></span></div>
                </div>
                  </div>
              <div class="booked-detls">
                    <div class="booked-detls-lft">
                  <div class="booked-detls-head">time</div>
                    ...
                    <div class="booked-detls-rgt">
                  <div class="booked-detls-dtls">: <span class="total-booked-person" id="booked-time-view"></span></div>
                </div>
                  </div>
              <div class="booked-detls">
                    <div class="booked-detls-lft">
                  <div class="booked-detls-head">Table</div>
                    ...
                    <div class="booked-detls-rgt">
                  <div class="booked-detls-dtls">: <span class="total-booked-person" id="booked-table-view"></span></div>
                </div>
                  </div>
              {{--
              <div class="booked-detls">
              ...
              <div class="booked-text" id="customer_special_request_view_sec" style="display:none;">
          ...
          @else
          <a class="hotel-bookmark-list-btn" href="{{url('/signup/?redirect_to='.$store_url.'/?p=book_table')}}">For Table Booking Click here to login</a>
          @endif
    </div>
        @endif
        @if(count($merchant_item_list)>0)
        <div class="booked_food" @if(count($store_table)>0) @if($p=='book_table')style="display:none;@endif @endif">
      <div class="row g-4">
            <div class="hotel-menu-lft">
          <div class="hotel-menu-lft-wrap sticky-bar">
              ...
              <ul class="menu-catagory-list">
                    ...
                    <li class="@if($count==0) active @endif cat_btn" data-id="{{$c_row->cat_id}}"><a href="javascript:;" >{{$c_row->category_name}}</a></li>
                    @php($count++)
                    @endforeach
                    @endif
                  </ul>
            ...
            <div class="menu-booking-list-wrap"> @if(count($item_list)>0)
          @php($count=0)
          @foreach($item_list as $c_row)
          <div class="item_cat_sec" id="item_cat-{{$c_row['cat_id']}}" @if($count!=0) style="display:none" @endif >
                <div class="hotel-menu-lft-head mb-3">
              <h4>{{$c_row['category_name']}}</h4>
            </div>
                <div class="hotel-pick-liswrap"> @if(count($c_row['items'])>0)
          ...
          <div class="cart-wrap-box sticky-bar">
              ...
              <h4>Cart<span class="sm-text total_cart_item_count">{{$total_cart_item}} Items</span></h4>
            </div>
                <div class="cart-wrap-body cart_items_section"> @if(count($cartinfo)>0)
              @foreach($cartinfo as $cart)
              <div class="crt-product-list d-flex justify-content-between align-items-center" id="cart-item-{{$cart['cart_id']}}">
                  ...
                  <div class="d-flex qty-item-add align-items-center priceControl">
                        ...
                        <input type="number" class="form-control qty-show count qty qtyInput2" value="{{$cart['quantity']}}" min="1" max="20" data-max-lim="20">
                  ...
                  <h3 id="grand_total-{{$cart['cart_id']}}">${{$cart['grand_total']}}</h3>
                </div>
                  </div>
              @endforeach
              @endif 
              ...
              <!--<div class="crt-product-list d-flex justify-content-between align-items-center">
                ...
                <div class="cart-wrap-ftr" id="cart_checkout_section" @if($total_cart_item==0) style="display:none;" @endif>
              <ul class="d-flex justify-content-between">
                    <li>
                  <h4>Sub Total</h4>
          ...
          <div class="table-booking-box sticky-bar">
              ...
              <li class="active">
                    <button type="button" class="table-process"><i class="fa-regular fa-calendar-days"></i></button>
                  </li>
              <li>
                    <button type="button" class="table-process"><i class="fa-regular fa-clock"></i></button>
                  </li>
              <li>
                    <button type="button" class="table-process"><i class="fa-regular fa-user"></i></button>
                  </li>
              <li>
                    <button type="button" class="table-process"><i class="fa-solid fa-info"></i></button>
                  </li>
            </ul>
              ...
              <div class="process-details">
                  ...
                  <button type="button" class="process-more-opt-btn">More Option<i class="fa-solid fa-plus"></i></button>
                </div>
                  </div>
            </div>
              ...
              <div class="process-details">
                  ...
                  <div class="row g-3">
                        <div class="gaust-input-wrap">
                      <input type="text" class="form-control gaust-input-style" placeholder="Customer Name">
                    </div>
                        <div class="gaust-input-wrap">
                      <input name="phone" type="tel" id="phone_prifix" class="form-control gaust-input-style">
                      <!-- <input type="number" class="form-control gaust-input-style" placeholder="Phone No."> --> 
                    </div>
                        <div class="gaust-input-wrap">
                      <input type="E-Mail" class="form-control gaust-input-style" placeholder="E-mail">
                    </div>
                        <div class="gaust-txtare-wrap">
      ...
      <div class="accordion">
          ...
          <div class="accordion-header" id="foodList">
              ...
              <div class="cart-list-wrap">
                  ...
                  <div class="col-auto">
                        <div class="d-flex">
                      <div class="food-type food-veg"> <i class="fa-regular fa-circle-dot"></i> </div>
                      <div class="food-name">
                            <h4>Lorem Ipsum</h4>
                            <p>Lorem Ipsum</p>
                          </div>
                  ...
                  <div class="pick-arrow">
                        <button data-bs-toggle="collapse" data-bs-target="#cartFood"><i class="fa-solid fa-angle-up"></i></button>
                      </div>
                </div>
                  </div>
            </div>
          ...
          <div id="cartFood" class="accordion-collapse collapse">
              ...
              <div class="cart-list-wrap">
                  ...
                  <div class="col-auto">
                        <div class="d-flex">
                      <div class="food-type food-nonveg"> <i class="fa-regular fa-circle-dot"></i> </div>
                      <div class="food-name">
                            <h4>Lorem Ipsum</h4>
                            <p>Lorem Ipsum</p>
                          </div>
